<?php
	...
	$mongo->insertarArticulo("ABBA", 50, NULL, "Pop", "ABBA", 1975, "Abba-Abba-Frontal.jpg", 11.00, 0);
	$mongo->insertarArticulo("Black Ice", 49, NULL, "Rock", "ACDC", 2008, "Ac_Dc-Black_Ice-Frontal.jpg", 19.00, 0);
	...
	$mongo->insertarArticulo("Bring Me To Life", 50, "NULL", "Rock", "Evanescence", 2001, "Evanescence-Bring_Me_To_Life_(Daredevil_Promo)-Frontal.jpg", 13.00, 0);
	...
	$mongo->insertarArticulo("1100 Bel Air Plac", 50, NULL, "Pop", "J. Iglesias", 1984, "julio_iglesias-1100_bel_air_place-Frontal.jpg", 16.00, 0);
	...
	$mongo->insertarArticulo("Ahora", 49, NULL, "Pop", "Rosa", 2003, "Rosa-Ahora-Frontal.jpg", 15.00, 0);
	...
	$mongo->insertarArticulo("Outnumber", 50, NULL, "Electronica/Dance", "Prodigy", 2004, "The _Prodigy-Always_Outnumbered_Never_Outgunned-Frontal.jpg", 10.00, 0);
	...
	echo "Usuarios y articulos insertados";
?>